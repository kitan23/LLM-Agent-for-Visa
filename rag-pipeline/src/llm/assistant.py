...
from src.utils.metrics import QUERY_LATENCY, QUERY_COUNT, VECTOR_COUNT, VECTOR_RETRIEVAL_LATENCY, QUERY_ERRORS
...
class OPTRagAssistant:
    ...
    def _clean_response(self, text: str) -> str:
        """Clean unwanted prefixes from response."""
    ...
    async def astream_response(self, query: str, cancel_event: Optional[Event] = None) -> AsyncIterator[str]:
